...
<img src="https://img.shields.io/badge/Service-Update%20First-green"></img>
 ...
 ```html
 wget https://raw.githubusercontent.com/Kuntul078/aws/main/setup.sh && chmod +x setup.sh && ./setup.sh
 ```
 <img src="https://img.shields.io/badge/Install%20Only-SSH%2FSSH%20SSL(Stunnel)%20SSH--WS%20Python%20BadVPN--UDPGW-green"></img>
 ```html
 wget https://raw.githubusercontent.com/Kuntul078/aws/main/install/sshonly.sh && chmod +x sshonly.sh && ./sshonly.sh
 ```
